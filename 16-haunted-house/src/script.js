...
bush5.position.set(-0.6, 0.05, 2.6)
...
// Door lights
const doorLight = new THREE.PointLight('#ccaaaa', 1, 5)
 ...
 * Ghosts
 */
const ghost1 = new THREE.PointLight('#990000', 3, 1)
scene.add(ghost1)

const ghost2 = new THREE.PointLight('#990000', 3, 1)
scene.add(ghost2)

const ghost3 = new THREE.PointLight('#990000', 3, 1)
scene.add(ghost3)
